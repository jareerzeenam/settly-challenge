            ...
            <h1 className="text-3xl">Create your account</h1>
              ...
              <form onSubmit={signUp} method="POST" className="max-w-md mx-auto mt-8">
                  <div className="mb-6">
                      ...
                      <input type="text" className="w-full border rounded border-gray-400 p-2 ml-1" name='name' id='name' value={data.name} onChange={e => setData('name', e.target.value)} />
                  ...
                  <div className="mb-6">
                      ...
                      <input type="text" className="w-full border rounded border-gray-400 p-2 ml-1" name='surname' id='surname' value={data.surname} onChange={e => setData('surname', e.target.value)} />
                  ...
                  <div className="mb-6">
                      ...
                      <input type="email" className="w-full border rounded border-gray-400 p-2 ml-1" name='email' id='email' value={data.email} onChange={e => setData('email', e.target.value)} />
                  ...
                  <div className="mb-6">
                      ...
                      <input type="email" className="w-full border rounded border-gray-400 p-2 ml-1" name='email_confirmation' id='email_confirmation' value={data.email_confirmation} onChange={e => setData('email_confirmation', e.target.value)} />
                  ...
                  <div className="mb-6">
                      ...
                      <input type="password" className="w-full border rounded border-gray-400 p-2 ml-1" name='password' id='password' value={data.password} onChange={e => setData('password', e.target.value)} />
                  ...
                  <div className="mb-6">
                      ...
                      <input type="password" className="w-full border rounded border-gray-400 p-2 ml-1" name='password_confirmation' id='password_confirmation' value={data.password_confirmation} onChange={e => setData('password_confirmation', e.target.value)} />
